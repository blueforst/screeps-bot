...
const PROBE_PATH = "__opencodeSkillProbe";

function printHelp() {
  console.log(`Screeps console API helper

Usage:
  node .opencode/skills/screeps-game-data/console-api.mjs --expr <expression> --shard <shard>
  node .opencode/skills/screeps-game-data/console-api.mjs --probe [--shards shard1,shard2]
