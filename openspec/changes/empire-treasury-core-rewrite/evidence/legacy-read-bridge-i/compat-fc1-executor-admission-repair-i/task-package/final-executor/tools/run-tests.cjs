...
const REQUIRED_FC1=['full-cost-executor.spec.cjs','full-cost-admission.spec.cjs'];
...
function run(o){
 ...
 const result={status:'FC1_FINAL_EXECUTOR_VERIFIED',packageFingerprint:pkg.fingerprint,
  legacyRiskRegressions:{files:contract.legacySpecFiles,...baseline.counts},
  finalFc1Composition:{files:contract.fc1ExecutorSpecFiles,...fc1.counts},
  tests:baseline.counts.tests+fc1.counts.tests,passed:baseline.counts.passed+fc1.counts.passed,
