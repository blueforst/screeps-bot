...
const base={authorizationId:'treasury-full-cost-FC1-online-I-2026-09-24',parentRunId:'d6ecc012d2d74b119c42b7b3f0f9f91a',fullCostMeasurement:true,measurementProtocol:'FC1',rooms:['E3N59','E4N58'],resources:['energy','H'],expected:{userId:'634fe406347a7b69b28aeccb'},backupBuild:{commit:'06ffedb7c558e0bc625f4a2ff450c474fb9d6f1c',tag:'backup'},safetyCpu:10};
const policy=packaged?base:require('../policy.json');
...
function cost(r,previous=null){const elapsed=r.cpuProfile.elapsed+.6;return{kind:'treasury-full-cost-sample',version:1,experimentId:policy.authorizationId,tick:r.tick,sampleOrdinal:r.cpuProfile.sampleOrdinal,windowStart:100,windowEnd:400,authorizesActions:false,performanceTargetCpu:null,policy:{cooperativeCeilingCpu:10,retainedReserveCpu:25,admissionHeadroomCpu:55,minBucket:2000,maxReceiptBytes:16384},nativeEntry:{used:50,limit:100,tickLimit:500,bucket:6000},nativeReturn:{used:50+elapsed,limit:100,tickLimit:500,bucket:6000},elapsedThroughPreviewReturn:elapsed,previewStatus:r.status,currentTailProfile:tail(r),previousReceiptOverhead:previous?{tick:previous.tick,elapsedAfterPreviewReturn:.1}:null,stopsFutureSamples:false,stopReason:null,measurementBoundary:'before-preview-run_to_after-preview-return'};}
